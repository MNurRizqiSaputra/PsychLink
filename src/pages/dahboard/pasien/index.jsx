...
import Content from "../../../components/Fragments/Dashboard/Content/Pasien/index";
import SidebarPasien from "../../../components/Fragments/Dashboard/Sidebar/Pasien";
...
const HomePasien = () => {
  ...
  return (
    <div className="mt-12 font-sans leading-normal tracking-normal bg-gray-800">
      ...
      <SidebarPasien onMenuClick={handleMenuClick} />
